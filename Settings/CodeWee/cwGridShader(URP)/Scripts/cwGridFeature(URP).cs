		...
		class DrawTagPass : ScriptableRenderPass
		{
			...
			public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
			{
				...
				using (new ProfilingScope(cmd, new ProfilingSampler(m_ProfilerTag)))
				{
					...
					// Actualización para evitar warning de DrawRenderers obsoleto
					// En versiones modernas de URP se usa el sistema de RendererList
					var param = new RendererListParams(renderingData.cullResults, drawSettings, m_Filtering);
